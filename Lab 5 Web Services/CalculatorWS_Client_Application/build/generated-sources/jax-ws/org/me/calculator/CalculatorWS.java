...
public interface CalculatorWS {
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "subtract", targetNamespace = "http://calculator.me.org/", className = "org.me.calculator.Subtract")
    @ResponseWrapper(localName = "subtractResponse", targetNamespace = "http://calculator.me.org/", className = "org.me.calculator.SubtractResponse")
    @Action(input = "http://calculator.me.org/CalculatorWS/subtractRequest", output = "http://calculator.me.org/CalculatorWS/subtractResponse")
    public int subtract(
        @WebParam(name = "i", targetNamespace = "")
        int i,
        @WebParam(name = "j", targetNamespace = "")
